import svgPaths from "./svg-8wk1y1707j";
  ...
  return (
    <div className="h-[45px] relative shrink-0 w-[88.532px]" data-name="Layer_1">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 88.5325 45">
        <g clipPath="url(#clip0_1_2359)" id="Layer_1">
...
function NavBar() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 top-[-150px] w-[1920px]" data-name="nav bar">
      <Header />
    </div>
  );
}
...
function LogoAnimation() {
  return <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[201px] left-[calc(50%-0.31px)] top-[calc(50%+0.5px)] w-[389.37px]" data-name="Logo Animation" />;
}
...
export default function Frame() {
  return (
    <div className="bg-[#030301] relative size-full">
      <NavBar />
      <LogoAnimation />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[274px] left-[calc(50%+0.5px)] top-1/2 w-px" data-name="image 2">
