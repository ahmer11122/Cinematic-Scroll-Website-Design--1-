import svgPaths from "./svg-1l1xdk1cpz";
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[2639px] left-[calc(50%+1px)] top-[calc(50%-346.5px)] w-[2158px]">
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      ...
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[64.4px] left-[114px] not-italic text-[#808080] text-[41.52px] top-[-344px] w-[813.05px]">Making complicated things feel ridiculously simple through thoughtful UX, product strategy, and visual systems built to reduce friction and create real impact.</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[1159px] not-italic text-[#fffff9] text-[40px] top-[297px] w-[597px]">Blending UX, product thinking, visual identity, and growth-focused design into experiences people instantly understand and actually remember.</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[114px] not-italic text-[#808080] text-[40px] top-[706px] w-[813.05px]">Good design isn’t decoration — it’s direction, shaping how people feel, interact, trust, and connect with a product from the very first click.</p>
    </div>
  );
}