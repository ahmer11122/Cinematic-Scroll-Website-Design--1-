import svgPaths from "./svg-w7kx66hopq";
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] capitalize font-['Satoshi:Black',sans-serif] h-[1080px] leading-[1.1] left-1/2 not-italic text-[142.014px] top-0 tracking-[-2.8403px] w-[1920px] whitespace-nowrap" data-name="about section">
      <p className="-translate-x-full absolute left-[-153px] text-[#0c0c0c] text-right top-[462px]">The stuff I’m</p>
      <p className="absolute left-[2071px] text-[#aeaeae] top-[467px]">good at.</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[709px] left-[calc(50%+120px)] top-[calc(50%+0.5px)] w-[576px]">
