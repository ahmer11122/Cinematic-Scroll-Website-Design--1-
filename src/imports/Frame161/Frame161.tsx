import svgPaths from "./svg-8pjll4rmlm";
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] capitalize font-['Satoshi:Black',sans-serif] h-[1080px] leading-[1.1] left-1/2 not-italic text-[142.014px] top-0 tracking-[-2.8403px] w-[1920px] whitespace-nowrap" data-name="about section">
      <p className="-translate-x-full absolute left-[-123.02px] text-[#0c0c0c] text-right top-[262px]">The stuff I’m</p>
      <p className="absolute left-[2088.12px] text-[#aeaeae] top-[267px]">good at.</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[2639px] left-[calc(50%+1px)] top-[calc(50%-761.5px)] w-[2158px]">
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      ...
      <Frame2 />
      <NavBar />
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[1159px] not-italic text-[#808080] text-[40px] top-[-563px] w-[691px] whitespace-pre-wrap">{`I’m Muhammad Usama  a Google-Certified UX Designer with 4+ years of experience designing products, brands, and digital experiences that feel clear, useful, and actually human.`}</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[64.4px] left-[114px] not-italic text-[#808080] text-[41.52px] top-[-444px] w-[813.05px]">Making complicated things feel ridiculously simple through thoughtful UX, product strategy, and visual systems built to reduce friction and create real impact.</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[1159px] not-italic text-[#808080] text-[40px] top-[197px] w-[597px]">Blending UX, product thinking, visual identity, and growth-focused design into experiences people instantly understand and actually remember.</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[114px] not-italic text-[#fffff9] text-[40px] top-[606px] w-[813.05px]">Good design isn’t decoration — it’s direction, shaping how people feel, interact, trust, and connect with a product from the very first click.</p>
      <div className="absolute flex h-[18px] items-center justify-center left-0 top-[1080px] w-[1920px]">
        <div className="-scale-y-100 flex-none">
          <div className="bg-[#0c0c0c] h-[18px] relative w-[1920px]" />
        </div>
      </div>
    </div>
  );
