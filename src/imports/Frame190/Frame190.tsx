import svgPaths from "./svg-lmcwhkyzjn";
...
function Project() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[7.215px] h-[575px] items-start justify-end left-[calc(50%-0.02px)] overflow-clip py-[35.351px] top-[calc(50%+94.5px)] w-[1087.955px]" data-name="PROJECT1">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
...
function Project1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[7.742px] h-[617px] items-start justify-end left-[calc(50%+1581.71px)] overflow-clip py-[37.934px] top-[calc(50%+92.5px)] w-[1167.423px]" data-name="PROJECT2">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
