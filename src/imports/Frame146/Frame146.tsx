import svgPaths from "./svg-yvmw1dwan3";
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] capitalize font-['Satoshi:Black',sans-serif] h-[1080px] leading-[1.1] left-1/2 not-italic text-[142.014px] top-0 tracking-[-2.8403px] w-[1920px] whitespace-nowrap" data-name="about section">
      <p className="absolute left-[611.98px] text-[#2c2c2c] top-[calc(50%-278px)]">Who</p>
      <p className="absolute left-[940.12px] text-[#aeaeae] top-[calc(50%-278px)]">I AM?</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 absolute h-[480px] left-1/2 top-[528px] w-[342px]">
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      <div className="absolute h-[1716px] left-[-272px] top-[-253px] w-[2464px]" data-name="image 2">
