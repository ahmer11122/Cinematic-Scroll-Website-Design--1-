import svgPaths from "./svg-byh81jkeun";
...
function Frame() {
  return (
    <div className="absolute h-[154px] left-[60px] top-[58px] w-[628px]">
...
function Frame1() {
  return (
    <div className="absolute h-[94px] left-[1281px] top-[258px] w-[569px]">
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] capitalize font-['Satoshi:Black',sans-serif] h-[1080px] leading-[1.1] left-1/2 not-italic overflow-clip text-[142.014px] top-0 tracking-[-2.8403px] w-[1920px] whitespace-nowrap" data-name="about section">
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 absolute h-[360px] left-1/2 opacity-0 top-[678px] w-[258px]">
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      <div className="absolute h-[1716px] left-[-272px] top-[-633px] w-[2464px]" data-name="image 2">
