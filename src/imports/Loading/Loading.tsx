import svgPaths from "./svg-a4tdei7vxb";
...
function NavBar() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 top-[-180px] w-[1920px]" data-name="nav bar">
      <Header />
    </div>
  );
}
...
function LogoAnimation() {
  return <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[201px] left-[calc(50%-0.32px)] top-[calc(50%+0.5px)] w-[389.37px]" data-name="Logo Animation" />;
}

export default function Loading() {
  return (
    <div className="bg-[#030301] relative size-full" data-name="loading">
      <NavBar />
      <LogoAnimation />
    </div>
  );
