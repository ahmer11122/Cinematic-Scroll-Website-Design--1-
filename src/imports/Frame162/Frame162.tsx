import svgPaths from "./svg-so9dr0rtiv";
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      ...
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[114px] not-italic opacity-0 text-[#fffff9] text-[40px] top-[606px] w-[813.05px]">Good design isn’t decoration — it’s direction, shaping how people feel, interact, trust, and connect with a product from the very first click.</p>
    </div>
  );
}