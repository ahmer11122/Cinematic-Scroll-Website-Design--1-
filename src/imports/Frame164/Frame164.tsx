import svgPaths from "./svg-elp3j9fmrp";
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] h-[1080px] left-1/2 top-0 w-[1920px]" data-name="about section">
      <div className="absolute bg-[#0c0c0c] h-px left-0 top-[1079px] w-[1920px]" />
      <p className="-translate-x-full absolute capitalize font-['Satoshi:Black',sans-serif] leading-[1.1] left-[1067px] not-italic text-[#2c2c2c] text-[132px] text-right top-[462px] tracking-[-2.64px] whitespace-nowrap">The stuff I’m</p>
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+120.5px)] size-px top-[calc(50%+0.5px)]">
