import svgPaths from "./svg-z6c2navjgp";
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] h-[1080px] left-1/2 overflow-clip top-0 w-[1920px]" data-name="about section">
      ...
      <p className="absolute capitalize font-['Satoshi:Bold',sans-serif] leading-[1.1] left-[1005.98px] not-italic text-[#aeaeae] text-[64px] top-[1191px] tracking-[-1.28px] whitespace-nowrap">{`Product design `}</p>
      <p className="absolute capitalize font-['Satoshi:Bold',sans-serif] leading-[1.1] left-[1005.98px] not-italic text-[#aeaeae] text-[64px] top-[1281px] tracking-[-1.28px] whitespace-nowrap">UX Strategy</p>
      <p className="absolute capitalize font-['Satoshi:Bold',sans-serif] leading-[1.1] left-[1005.98px] not-italic text-[#aeaeae] text-[64px] top-[1371px] tracking-[-1.28px] whitespace-nowrap">{`Brand & Visual Identity`}</p>
      <p className="absolute capitalize font-['Satoshi:Bold',sans-serif] leading-[1.1] left-[1005.98px] not-italic text-[#aeaeae] text-[64px] top-[1461px] tracking-[-1.28px] whitespace-nowrap">Growth-Focused Design</p>
      <p className="-translate-x-full absolute capitalize font-['Satoshi:Black',sans-serif] leading-[1.1] left-[1067px] not-italic text-[#aeaeae] text-[132px] text-right top-[462px] tracking-[-2.64px] whitespace-nowrap">The stuff I’m</p>
      <p className="absolute capitalize font-['Satoshi:Black',sans-serif] leading-[1.1] left-[1090px] not-italic text-[#aeaeae] text-[132px] top-[467px] tracking-[-2.64px] whitespace-nowrap">good at.</p>
    </div>
  );
}
