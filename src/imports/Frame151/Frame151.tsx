import svgPaths from "./svg-p2zbpbk2yj";
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] capitalize font-['Satoshi:Black',sans-serif] h-[1080px] leading-[1.1] left-1/2 not-italic text-[142.014px] top-0 tracking-[-2.8403px] w-[1920px] whitespace-nowrap" data-name="about section">
      <p className="absolute left-[-528.02px] text-[#2c2c2c] top-[262px]">Who</p>
      <p className="absolute left-[2080.12px] text-[#aeaeae] top-[262px]">I AM?</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[2639px] left-[calc(50%+1px)] top-[calc(50%+547.5px)] w-[2158px]">
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      ...
      <Frame2 />
      <NavBar />
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[1159px] not-italic text-[#fffff9] text-[40px] top-[327px] w-[691px] whitespace-pre-wrap">{`I’m Muhammad Usama  a Google-Certified UX Designer with 4+ years of experience designing products, brands, and digital experiences that feel clear, useful, and actually human.`}</p>
      <p className="absolute font-['Satoshi:Black',sans-serif] leading-[64.4px] left-[1159px] not-italic text-[#fffff9] text-[41.52px] top-[1067px] w-[813.05px]">I’m Muhammad Usama, a Google-Certified UX Designer driven by curiosity about how people think, choose, and move through digital products.</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[114px] not-italic text-[#808080] text-[40px] top-[736px] w-[813.05px]">Making complicated things feel ridiculously simple through thoughtful UX, product strategy, and visual systems built to reduce friction and create real impact.</p>
      <p className="absolute font-['Satoshi:Black',sans-serif] leading-[64.4px] left-[114px] not-italic text-[#808080] text-[41.52px] top-[1476px] w-[813.05px]">I design clear, scalable user journeys that reduce friction, build trust, and help products grow through better experiences not louder features.</p>
    </div>
  );
}