import svgPaths from "./svg-we0cjc50tn";
...
function Frame2() {
  return (
    <div className="-translate-y-1/2 absolute h-[152px] left-[1273px] overflow-clip top-[calc(50%+43px)] w-[569px]">
      <div className="absolute font-['Satoshi:Regular',sans-serif] h-[127px] leading-[0] left-0 not-italic text-[#fffff9] text-[0px] top-0 w-[588px] whitespace-pre-wrap">
...
function AboutSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f9f9f9] capitalize font-['Satoshi:Black',sans-serif] h-[1080px] leading-[1.1] left-1/2 not-italic text-[142.014px] top-[1280px] tracking-[-2.8403px] w-[1920px] whitespace-nowrap" data-name="about section">
      <p className="absolute left-[611.98px] text-[#2c2c2c] top-[262px]">Who</p>
      <p className="absolute left-[940.12px] text-[#aeaeae] top-[262px]">I AM?</p>
    </div>
  );
}
...
export default function Frame() {
  return (
    <div className="bg-[#030301] relative size-full">
      <div className="absolute h-[1568px] left-[-434px] top-[-249px] w-[2788px]" data-name="image 2">
