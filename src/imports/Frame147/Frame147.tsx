import svgPaths from "./svg-jb0xj41y04";
...
function Frame2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[2639px] left-[calc(50%+1px)] top-[calc(50%+546.5px)] w-[2158px]">
...
export default function Frame3() {
  return (
    <div className="bg-[#030301] relative size-full">
      ...
      <Frame2 />
      <NavBar />
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[1159px] not-italic opacity-0 text-[#fffff9] text-[40px] top-[327px] w-[691px] whitespace-pre-wrap">{`I’m Muhammad Usama  a Google-Certified UX Designer with 4+ years of experience designing products, brands, and digital experiences that feel clear, useful, and actually human.`}</p>
      <p className="absolute font-['Satoshi:Regular',sans-serif] leading-[56px] left-[114px] not-italic opacity-0 text-[#808080] text-[40px] top-[736px] w-[813.05px]">Making complicated things feel ridiculously simple through thoughtful UX, product strategy, and visual systems built to reduce friction and create real impact.</p>
    </div>
  );
}